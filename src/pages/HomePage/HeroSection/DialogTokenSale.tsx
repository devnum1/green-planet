...
import {
  CONTRACT_ABI,
  NUMBER_OF_PURCHASED_TOKENS_BY_CASH,
  REGEX_NUMBER_VALID,
...
export default function DialogTokenSale({
  dialogOpened,
  setDialogOpened,
  sizeOfDialog,
  totalTokenAmount,
  ...
  const { data: contractWriteData, write: purchase } =
  ...
  useEffect(() => {
    if (transactionSuccess && numberOfLoad === 0) {
      if (affiliateToken) {
        api
          .post("/affiliate/pay-to-affiliator", {
            tokenAmount: `${(Number(tokenAmount) / 100) * 4}`,
            affiliateToken,
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-sm">
                ...
                <span className="font-bold">
                  {getVisibleAmount(totalTokenAmount)}
                </span>{" "}
                ECO
                <br />
                ($
                <span className="font-bold">
                  {getVisibleAmount(
                    totalTokenAmount * tokenPriceInEth * ethPriceInUsd
                  )}
                </span>{" "}
                USD)
              </p>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <label htmlFor="eco" className="text-gray-900 font-bold">
                ECO:
              </label>
              <Input
                id="eco"
                ...
                endAdornment={
                  <div className="flex items-center gap-1">
                    <img
                      src="/assets/images/token_mark.png"
                      alt="ECO"
                      className="w-6"
                    />
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="eth" className="text-gray-900 font-bold">
                Ethereum:
              </label>
              <Input
                id="eth"
