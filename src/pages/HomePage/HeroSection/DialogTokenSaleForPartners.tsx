...
export default function DialogTokenSaleForPartners({
  dialogOpened,
  setDialogOpened,
  sizeOfDialog,
}: IProps) {
      ...
      <DialogBody className="px-6" divider>
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            <Progress
              value={
                ((totalTokenAmount - mintableTokenAmount) / totalTokenAmount) *
                100
              }
            ...
            <div className="flex justify-between items-center">
              <p className="text-sm">
                ...
                <span className="text-primary font-bold">
                  {getVisibleAmount(totalTokenAmount - mintableTokenAmount)}
                </span>{" "}
                ECO
              </p>
              <p className="text-sm">
